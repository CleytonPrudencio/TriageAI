...
DOMAIN_SYNONYMS = {
    ...
    'docker': 'infra_tecnico',
    'dockerfile': 'infra_tecnico',
    'container': 'infra_tecnico',
    'kubernetes': 'infra_tecnico',
    'deploy': 'infra_tecnico',
    'pipeline': 'infra_tecnico',
    'ci/cd': 'infra_tecnico',
    'jenkins': 'infra_tecnico',
    'nginx': 'infra_tecnico',
    'servidor': 'infra_tecnico',
    'banco de dados': 'banco_tecnico',
    'postgresql': 'banco_tecnico',
    'mysql': 'banco_tecnico',
    'h2': 'banco_tecnico',
    'redis': 'banco_tecnico',
    'migration': 'banco_tecnico',
    'sql': 'banco_tecnico',
    'application': 'config_tecnico',
    'configurar': 'config_tecnico',
    'configuracao': 'config_tecnico',
    'ambiente': 'config_tecnico',
    'local': 'config_tecnico',
    'endpoint': 'dev_tecnico',
    'api': 'dev_tecnico',
    'backend': 'dev_tecnico',
    'frontend': 'dev_tecnico',
    'codigo': 'dev_tecnico',
    'refatorar': 'dev_tecnico',
    'implementar': 'dev_tecnico',
    'build': 'dev_tecnico',
    'compilar': 'dev_tecnico',
    'dependencia': 'dev_tecnico',
    'pom.xml': 'dev_tecnico',
    'spring': 'dev_tecnico',
    'java': 'dev_tecnico',
    'python': 'dev_tecnico',
